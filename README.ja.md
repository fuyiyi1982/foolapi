...
_✨ one-api の変更されたフォークであり、非管理者ユーザー向けのポータル隔離機能を備えています。標準的な OpenAI API フォーマットを通じてすべての LLM にアクセスでき、導入と利用が容易です ✨_
...
<p align="center">
  ...
  <a href="#usage">使用方法</a>
  ·
  <a href="https://github.com/fuyiyi1982/foolapi/issues">フィードバック</a>
  ·
...
### マニュアルデプロイ
1. [GitHub Releases](https://github.com/fuyiyi1982/foolapi/releases/latest) から実行ファイルをダウンロードする、もしくはソースからコンパイルする:
   ```shell
...
詳しい手順は [#175](https://github.com/fuyiyi1982/foolapi/issues/175) を参照してください。

配置後に空白のページが表示される場合は、[#97](https://github.com/fuyiyi1982/foolapi/issues/97) を参照してください。
